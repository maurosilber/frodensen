...
For the restricted class of p.d.f's satisfying \eqref{eq:8.26},
one sees that the factorization requirement of \eqref{eq:8.25}
...
To see this,
we take logarithms on both sides of \eqref{eq:8.25}
...
\end{equation}
%
We see that the efficiency condition \eqref{eq:8.14}
is just a special case of the more general \eqref{eq:8.28}, with
%
\begin{equation}
...
However, there will be just one sufficient statistic which will satisfy \eqref{eq:8.29}
